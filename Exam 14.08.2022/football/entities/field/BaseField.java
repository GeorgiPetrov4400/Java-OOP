...
public abstract class BaseField implements Field {
    ...
    private String name;
    private int capacity; //The numbers of Player а Field can have.
    ...
    public String getInfo() {
        ...
        if (players.isEmpty()) {
            builder.append("Player: none");
        } else {
            builder.append("Player:");
            for (Player player : players) {
                builder.append(String.format(" %s", player.getName()));
            }
        }
        builder.append(System.lineSeparator());
        builder.append(String.format("Supplement: %d", supplements.size()));
        builder.append(System.lineSeparator());
